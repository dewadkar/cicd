...
exports.buildJenkinJob = function(req, res) {

	var prop = {};
	prop.jenkinsHost = 'http://dpev179.innovate.moon.com:8080/';
	prop.jenkinsJobName = 'rtc-urbancode-demo';

	var jenkins = require('../lib/jenkins');
	var isBuildTriggered = '';
	promise.then(isBuildTriggered = jenkins.buildJob(prop));
	console.log('Is build triggered' + isBuildTriggered);
